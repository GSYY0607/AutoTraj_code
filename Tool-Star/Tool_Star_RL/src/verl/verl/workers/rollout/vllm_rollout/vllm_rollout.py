...
"""
import sys
sys.path.append('/to/your/path/Tool-Star/Tool_Star_RL/src/verl/verl/workers/rollout/vllm_rollout/') # for importing web_search
...
class vLLMRolloutWithSearch(vLLMRollout):
    ...
    def batch_search(self, query: Union[str, List[str]], top_n=1) -> List[str]:
        ...
        url = f'your path/batch_search' #your local search path
